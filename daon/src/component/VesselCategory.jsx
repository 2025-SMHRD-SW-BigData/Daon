    ...
    <div className="phon_size">
      ...
      <div className="vessel-wrapper">
        ...
        <div className="vessel-buttons">
          ...
          <button onClick={() => handleNavigate('/purseine')} className="vessel-btn">선망어선</button>
          <button onClick={() => handleNavigate('/trapboat')} className="vessel-btn">통발어선</button>
          <button onClick={() => handleNavigate('/divingboat')} className="vessel-btn">잠수기어선</button>
