// ✅ Login.jsx - 로그인 버튼 클릭 시 boat-sail.mp4 재생 추가
  ...
  return (
    <div className="join-container"
      style={{
        ...
        borderRadius: '24px', border: '1px solid #ccc', overflow: 'hidden',
        boxShadow: '0 4px 12px rgba(0,0,0,0.1)', backgroundColor: '#fff',
